...
public class RegisterTeacherActivityTest {
    ...
    private String TEST_REGISTER_BEACON = "1234";
    ...
    public void registerNewTeacher(){
        TEST_REGISTER_USER = getSaltString() + "@temple.edu";

        onView(ViewMatchers.withId(R.id.createAccount))
                .perform(ViewActions.click());

        onView(ViewMatchers.withId(R.id.teacherAccPic))
                .perform(ViewActions.click());
        ...
        onView(ViewMatchers.withId(R.id.BeaconIDtxtBox))
                .perform(ViewActions.clearText())
                .perform(ViewActions.typeText(TEST_REGISTER_BEACON), ViewActions.closeSoftKeyboard());
